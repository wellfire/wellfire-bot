...
#
# Commands:
#   harvest invoices - returns the total count of open invoices and their sum
#   harvest open invoices - returns the ID, subject, amount, due date, and URL for each open invoice
...
harvest_request = (msg, url, handler) ->
  ...
  harvest_url = "https://#{process.env.HUBOT_HARVEST_URL}.harvestapp.com"
